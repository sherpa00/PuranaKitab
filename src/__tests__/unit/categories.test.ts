...
import { GetCategoriesBestSeller, GetCategoriesNewArrivals, GetCategoriesRecentlyAdded, GetCategoriesTopRated } from '../../services/categories.service'
...
describe('Testing get categories best seller books', () => {
    ...
    it('Should return success response when getting categories best seller books with pagination', async() => {
        ;(db.query as jest.Mock)
            ...
            .mockResolvedValueOnce(mockedGetBooksDbQuery)
