...
(req, payload, done) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // find the user
        const foundUser = yield db_configs_1.db.query('SELECT userid,username,email,role,createat,last_logout FROM users WHERE userid = $1 AND password = $2', [payload.sub, payload.subPass]);
