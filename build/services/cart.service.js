...
const GetAllCart = (userID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_utils_1.default.error(err, 'Error while gettting all carts');
        return {
            success: false,
            message: 'Failed to get all carts'
        };
...
const AddCart = (userID, bookID, bookQuantity) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundBookWithBookid = yield db_configs_1.db.query('SELECT price, available_quantity FROM books WHERE bookid = $1', [
            bookID
        ]);
        ...
        const totalBookPrice = bookQuantity * originalBookPrice;
        // add new cart to db
...
const UpdateCart = (userID, cartID, bookQuantity) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundCart = yield db_configs_1.db.query('SELECT bookid, original_price FROM carts WHERE carts.cartid = $1 AND carts.userid = $2', [cartID, userID]);
...
const RemoveSingleCart = (userID, cartID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundCart = yield db_configs_1.db.query('SELECT cartid FROM carts WHERE carts.cartid = $1 AND carts.userid = $2', [
            cartID,
            userID
        ]);
        if (foundCart.rowCount <= 0) {
        ...
        // remove cart
        const removeSingleCartStatus = yield db_configs_1.db.query('DELETE FROM carts WHERE carts.cartid = $1 AND carts.userid = $2 RETURNING *', [cartID, userID]);
...
const RemoveAllCart = (userID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // verify if cart exists or not
        const foundCart = yield db_configs_1.db.query('SELECT cartid FROM carts WHERE carts.userid = $1', [userID]);
        if (foundCart.rowCount <= 0) {
            return {
                success: false,
        ...
        // remove cart
        const removeAllCartStatus = yield db_configs_1.db.query('DELETE FROM carts WHERE carts.userid = $1 RETURNING *', [userID]);
