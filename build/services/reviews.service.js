...
const AddReview = (userID, bookID, userName, reviewStars, reviewMessage) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const reviewsFound = yield db_configs_1.db.query('SELECT * FROM reviews WHERE userid = $1 AND bookid = $2', [
        userID,
        bookID
      ])
      ...
      // add reviews
      const bookReviewAddStatus = yield db_configs_1.db.query(
...
const RemoveSinlgeReview = reviewID =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // remove book reivew
      const removeBookReviewStatus = yield db_configs_1.db.query(
        'DELETE FROM reviews WHERE reviews.reviewid = $1 RETURNING *',
        [reviewID]
      )
...
const RemoveAllReviews = bookID =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // revove book reviews
      const removeBookReviewsStatus = yield db_configs_1.db.query('DELETE FROM reviews WHERE bookid = $1 RETURNING *', [
        bookID
      ])
