...
const ResetPassword = (resetToken, newPassword) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const foundResetToken = yield db_configs_1.db.query(
      ...
      const foundUser = yield db_configs_1.db.query('SELECT * FROM users WHERE users.email = $1', [
      ...
      // update user db
      const updateUserPassword = yield db_configs_1.db.query(
        'UPDATE users SET password = $1 WHERE users.email = $2 RETURNING *',
      ...
      const removeResetToken = yield db_configs_1.db.query(
