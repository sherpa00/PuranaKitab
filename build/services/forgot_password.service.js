...
const ForgotPassword = (email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundUser = yield db_configs_1.db.query('SELECT userid,username,email FROM users WHERE users.email = $1', [email]);
        ...
        const addTokenToDb = yield db_configs_1.db.query('INSERT INTO reset_tokens(email, token, expiry_date) VALUES ($1, $2, $3) RETURNING userid,username,email', [email, token, expireDate]);
