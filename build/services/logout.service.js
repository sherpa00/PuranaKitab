...
const LogOut = (authenticatedUserId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateLastLogout = yield db_configs_1.db.query('UPDATE users SET last_logout = TO_TIMESTAMP($1 / 1000.0) WHERE userid = $2 RETURNING userid,username,email', [currentTimestamp, authenticatedUserId]);
