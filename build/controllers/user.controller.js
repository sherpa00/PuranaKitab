...
exports.DeleteOneUser = exports.UpdateOnePassword = exports.UpdateOneEmail = exports.UpdateOneUsername = exports.GetOneUserData = void 0;
const http_status_codes_1 = require("http-status-codes");
const user_service_1 = require("../services/user.service");
const express_validator_1 = require("express-validator");
const custom_error_1 = __importDefault(require("../utils/custom-error"));
// controller for get the user data
const GetOneUserData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const UpdateOneUsername = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
...
const UpdateOneEmail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const validatonErrors = (0, express_validator_1.validationResult)(req);
        if (!validatonErrors.isEmpty()) {
...
const UpdateOnePassword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const validatonErrors = (0, express_validator_1.validationResult)(req);
        if (!validatonErrors.isEmpty()) {
        ...
        const authenticatedUserData = req.user;
        const authenticatedUserId = authenticatedUserData.userid;
        const updatePasswordStatus = yield (0, user_service_1.UpdatePassword)(authenticatedUserId, req.body.oldpassword, req.body.newpassword);
