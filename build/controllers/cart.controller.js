...
exports.RemoveAllOneCart = exports.RemoveSingleOneCart = exports.UpdateOneCart = exports.AddOneCart = exports.GetOneAllCart = void 0;
const express_validator_1 = require("express-validator");
const custom_error_1 = __importDefault(require("../utils/custom-error"));
const cart_service_1 = require("../services/cart.service");
const http_status_codes_1 = require("http-status-codes");
// controller for adding cart
const GetOneAllCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// controller for adding cart
const AddOneCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
...
const UpdateOneCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const cartInputErrors = (0, express_validator_1.validationResult)(req);
        if (!cartInputErrors.isEmpty()) {
...
const RemoveSingleOneCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const cartInputErrors = (0, express_validator_1.validationResult)(req);
        if (!cartInputErrors.isEmpty()) {
...
// controller for deleting single cart
const RemoveAllOneCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // get the authorized user and userid
        const authenticatedUser = req.user;
        const authenticatedUserId = authenticatedUser.userid;
