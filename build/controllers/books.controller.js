...
exports.RemoveBookImage =
  exports.UploadBookImage =
  exports.AddBookImage =
  exports.RemoveOneBook =
  exports.UpdateOneBook =
  exports.GetBookById =
  exports.GetAllOneBooks =
  exports.addOneNewBook =
    void 0
...
const GetAllOneBooks = (req, res, next) =>
...
const addOneNewBook = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // input validation
...
const AddBookImage = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b
    try {
      // validationn errors
      ...
      const localImagePath =
        (_b = (_a = req.file) === null || _a === void 0 ? void 0 : _a.path) !== null && _b !== void 0 ? _b : ''
      // params and query
      const bookid = parseInt(req.params.bookid)
...
const UploadBookImage = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
      const localImagePath =
        (_d = (_c = req.file) === null || _c === void 0 ? void 0 : _c.path) !== null && _d !== void 0 ? _d : ''
      // params and query
      const bookid = parseInt(req.params.bookid)
      const bookImgType = String(req.query.type).toUpperCase()
      // upload the image by calling upload image service
...
const RemoveBookImage = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // validation errors
      const BookInputErrors = (0, express_validator_1.validationResult)(req)
