...
exports.RemoveBookImage = exports.UploadBookImage = exports.AddBookImage = exports.RemoveOneBook = exports.UpdateOneBookGenre = exports.UpdateOneBookAuthor = exports.UpdateOneBook = exports.GetBookById = exports.GetAllOneBooks = exports.addOneNewBook = void 0;
const http_status_codes_1 = require("http-status-codes");
const express_validator_1 = require("express-validator");
const books_service_1 = require("../services/books.service");
const custom_error_1 = __importDefault(require("../utils/custom-error"));
const textManipulation_1 = require("../helpers/textManipulation");
...
const GetAllOneBooks = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const bookGenre = req.query.genre !== null && req.query.genre !== undefined
            ? (0, authors_controller_1.capitalize)(String(req.query.genre).toLowerCase())
            : req.query.genre;
        // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        const bookAuthor = req.query.author !== null && req.query.author !== undefined
            ? (0, textManipulation_1.convertToAcceptableFullname)(String(req.query.author))
            : req.query.author;
        // get books results
        let getAllBooksStatus;
        if ((req.query.page === null || req.query.page === undefined) &&
            ...
            getAllBooksStatus = yield (0, books_service_1.GetAllBooks)(bookGenre, bookAuthor);
        }
        else {
            ...
            getAllBooksStatus = yield (0, books_service_1.GetAllBooks)(bookGenre, bookAuthor, page, size);
        }
...
const GetBookById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!getBookByIdStatus.success) {
            const error = new custom_error_1.default(`No Book with id: ${req.params.bookid} found`, 404);
            throw error;
        }
...
const addOneNewBook = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        book_condition, 
        // eslint-disable-next-line @typescript-eslint/naming-convention
        available_quantity, isbn, description, genre, authorFirstname, authorLastname } = req.body;
...
const UpdateOneBookAuthor = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const validationError = (0, express_validator_1.validationResult)(req);
        if (!validationError.isEmpty()) {
        ...
        const newAuthorFirstname = req.body.firstname;
        const newAuthorLastname = req.body.lastname;
        // call update book author
        const updateBookAuthorStatus = yield (0, books_service_1.UpdateBookAuthor)(newAuthorFirstname, newAuthorLastname, bookid);
...
exports.UpdateOneBookAuthor = UpdateOneBookAuthor;
// controller for updating book genre
const UpdateOneBookGenre = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // validation error
        const validationError = (0, express_validator_1.validationResult)(req);
        if (!validationError.isEmpty()) {
        ...
        const updateBookGenreStatus = yield (0, books_service_1.UpdateBookGenre)(newGenre, bookid);
...
exports.UpdateOneBookGenre = UpdateOneBookGenre;
