...
exports.RemoveAllOneBookReviews =
  exports.RemoveSingleOneBookReview =
  exports.GetAllOneBookReview =
...
const GetAllOneBookReview = (req, res, next) =>
...
const AddOneReview = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // validation errors
      const reviewInputErrors = (0, express_validator_1.validationResult)(req)
      ...
      const addBookReviewStatus = yield (0, reviews_service_1.AddReview)(
        authenticatedUserId,
        bookID,
...
const RemoveSingleOneBookReview = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // validation errors
      const reviewInputErrors = (0, express_validator_1.validationResult)(req)
...
// controllers for removing all book reviews
const RemoveAllOneBookReviews = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // validation errors
      const reviewInputErrors = (0, express_validator_1.validationResult)(req)
