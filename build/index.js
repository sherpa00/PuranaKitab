...
const forgot_password_route_1 = require('./routes/forgot-password.route')
const reset_password_route_1 = require('./routes/reset-password.route')
// server application
...
app.use('/forgot-password', forgot_password_route_1.ForgotPasswordRouter)
// reset passoword routes
app.use('/reset-password', reset_password_route_1.ResetPasswordRouter)
// book routes
